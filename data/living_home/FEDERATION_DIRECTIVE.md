...
17. Hollywood skills — **VERIFIED** 2026-09-09. Merovin director + Draven continuity wired to existing MD_Cinema. Speech ≠ Hollywood ≠ film. Do not mix into seating tests. Spec: `CINEMA_PRODUCTION.md`.  
18. Matrix skins (GitHub) — **WAITING.** Separate visual-asset task. Not identity. Not Federation seating.  
19. Matrix-Game adapter — **VERIFIED** 2026-09-09 as honest UNAVAILABLE (`prove matrix-game`, `PROVE_MATRIX_GAME_ADAPTER.json`). Engine still **NOT INSTALLED** on this Windows 4060 8GB. 3.0 primary research; keep 2.0 as secondary. Do not install expecting demo quality.  
...
Operator surface: `NEXT.md`. Merovin, Draven, and Vesper federation speech **VERIFIED**. Vesper house-voice thinking leak NEED MORE. Hollywood skills **VERIFIED** 2026-09-09 (two independent MD_Cinema wirings; not a film). Matrix-Game adapter **VERIFIED** 2026-09-09 as honest UNAVAILABLE (`PROVE_MATRIX_GAME_ADAPTER.json`; engine not installed). Federation integrity 2026-09-09: Vesper Gameworld door **VERIFIED** → Identity/Isolation Matrix **VERIFIED** (Gemini pulse UNKNOWN) → Vesper restart **VERIFIED** (`_2`) → bounded organic **VERIFIED** (not a scheduler). Scheduler later. Self-wiring / tool claiming later (after organic / with scheduler; **not** Phase 13; do not build now). Colibri paging later. No `mythos_simplified/`.

Cinema production lane is **after speech:** Hollywood skills **VERIFIED** 2026-09-09 → Matrix skins (WAITING) → Matrix-Game adapter **VERIFIED** as honest UNAVAILABLE → production proof. Do not install Matrix-Game. Do not mix Hollywood into seating tests. Spec: `CINEMA_PRODUCTION.md`. Observer ZIP stays frozen.
